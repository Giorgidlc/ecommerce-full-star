...
import ShoppingCartModel from '../src/models/shoppingCartModel.ts';
import { ShoppingCarts, HttpShoppingCartResponse } from '../src/types/shoppingCartsTypes.ts';
...
//-----------------------------------------------GET---------------------------------------------------------------------
    let response: HttpShoppingCartResponse<ShoppingCarts>;
