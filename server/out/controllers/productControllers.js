...
exports.deleteProductByName = exports.deleteProductById = exports.updateProduct = exports.createProduct = exports.getProduct = exports.getProducts = void 0;
...
var getProducts = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel_1.default.findAll()];
            case 1:
                products = _a.sent();
                if (!products) {
                    return [2 /*return*/, res.status(404).json({ message: 'Products not found' })];
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                productId = req.params.id;
                return [4 /*yield*/, productModel_1.default.update(req.body, productId)];
            case 1:
...
var deleteProductById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, eliminatedProduct, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                productId = req.params.id;
                return [4 /*yield*/, productModel_1.default.eliminateById(productId)];
            case 1:
                eliminatedProduct = _a.sent();
                if (!eliminatedProduct) {
                    return [2 /*return*/, res.status(404).json({ message: 'Product Not Found' })];
                }
                return [2 /*return*/, res.json({ message: 'The Product has been eliminated succesfully' })];
            case 2:
                error_5 = _a.sent();
...
var deleteProductByName = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, eliminatedProduct, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
