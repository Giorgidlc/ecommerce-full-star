...
import {getShoppingCartDetail, getShoppingCartsDetails, createShoppingCartDetail, updateShoppingCartDetail, deleteShoppingCartDetailById} from '../controllers/shoppingCartDetailsController'
